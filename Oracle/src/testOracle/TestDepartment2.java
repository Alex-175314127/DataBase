...
public class TestDepartment2 {
    public static void main(String[] args) {
        ...
        dept.readEmployees();
        for (int i = 0; i < dept.getListEmployee().size(); i++) {
            System.out.println(dept.getListEmployee().get(i).toString());
        }
        
        Department dept1 = new Department(20,"Marketing");
        dept1.readEmployees();
        for (int i = 0; i < dept1.getListEmployee().size(); i++) {
            System.out.println(dept1.getListEmployee().get(i).toString());
        }
